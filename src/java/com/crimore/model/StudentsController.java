...
public class StudentsController implements Serializable
{
    ...
    @EJB
    private com.crimore.model.StudentsFacade ejbFacade;
    private List<Students> items = null;
    private Students selected;
    ...
    public void create()
    {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("StudentsCreated"));
    ...
    public void update()
    {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("StudentsUpdated"));
    }

    public void destroy()
    {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("StudentsDeleted"));
        if (!JsfUtil.isValidationFailed())
        {
    ...
    public List<Students> getItemsAvailableSelectMany()
    {
        return getFacade().findAll();
    }

    public List<Students> getItemsAvailableSelectOne()
    {
        return getFacade().findAll();
    }
    ...
    public static class StudentsControllerConverter implements Converter
    {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object)
        {
            ...
            } else
            {
                ...
                {
                    object, object.getClass().getName(), Students.class.getName()
                });
                return null;
            }
        }
